...
public class MybatisPlusCodeGenerator {
    ...
    public MybatisPlusCodeGenerator(MybatisPlusGeneratorProperties mybatisPlusGeneratorProperties) {
    ...
    public void codeGenerator(){
        ...
        String model = mybatisPlusGeneratorProperties.getModel();
        String projectPath = System.getProperty("user.dir");
        if(model != null){
            projectPath =  projectPath + "/" + model;
        }
        gc.setOutputDir(projectPath + "/src/main/java");
        gc.setAuthor(mybatisPlusGeneratorProperties.getAuthor());
        gc.setOpen(false);
        gc.setSwagger2(mybatisPlusGeneratorProperties.isEnableSwagger()); //实体属性 Swagger2 注解
...
//        pc.setModuleName(scanner("模块名"));
        pc.setParent(mybatisPlusGeneratorProperties.getJavaPath());
...
//        strategy.setInclude(scanner("表名，多个英文逗号分割").split(","));
        strategy.setInclude();// 初始化当前数据库下的所有实体对象
